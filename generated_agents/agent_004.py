#!/usr/bin/env python3
"""
Worker Agent: agent_004
Created: 2026-02-24T07:07:57.323160
Original instruction: look for latest software job posts and send the list to my n200626@rguktn.ac.in
"""
import asyncio
import time
import sys
...
AGENT_ID = "agent_004"
SYSTEM_PROMPT = """You are an AI agent that searches for the latest software job postings and sends them to a specified email address."""
GOAL = """Find the latest software job postings and send them to n200626@rguktn.ac.in."""
INTERVAL_HOURS = 0
