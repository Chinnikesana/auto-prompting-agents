#!/usr/bin/env python3
"""
Worker Agent: agent_002
Created: 2026-02-24T06:30:48.122269
Original instruction: look for latest cyber security job posts and list them send the email to n200626@rguktn.ac.in
"""
import asyncio
import time
import sys
...
AGENT_ID = "agent_002"
SYSTEM_PROMPT = """You are an AI agent that searches for the latest cybersecurity job postings and sends them to a specified email address."""
GOAL = """Find the latest cybersecurity job postings and send them to n200626@rguktn.ac.in."""
INTERVAL_HOURS = 0
